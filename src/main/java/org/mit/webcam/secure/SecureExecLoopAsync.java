...
public class SecureExecLoopAsync implements Runnable {
	
	private Map<String, CtxRunnableAsync> handlers;
	private SynchronousQueue<ExecContext> fifoActions;
	private SynchronousQueue<Object> retValues;
	public SecureExecLoopAsync(Map<String, CtxRunnableAsync> handlers) {
	...
	private void handle(CtxRunnableAsync handler, Map<String, Object> ctx) {
